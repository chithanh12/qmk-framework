...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_BASE] = LAYOUT(
    ...
    TD(T_ESC), KC_A,    KC_S,    KC_D,    KC_F,    KC_G,                      KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_BSPC,
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                      KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, KC_UP, 
    MO_LOWR, KC_LCTL, KC_LALT, KC_LGUI, KC_SPC,                             KC_ENT, KC_RGUI, MO_LOWR, MO_RAIS, KC_RCTRL, KC_PGUP, KC_PGDOWN
  ),
   ...
   * LOWER
   * ┌─────┬─────┬─────┬─────┬─────┬─────┬─────┐     ┌─────┬─────┬─────┬─────┬─────┬─────┬─────┬─────┐
   * │  `~ │  F1 │ F2  │ F3  │ F4  │ F5  │ F6  │     │ F7  │ F8  │ F9  │ F10 │ F11 │ F12 │BSLS │ DEL │ 
   * ├─────┴──┬──┴──┬──┴──┬──┴──┬──┴──┬──┴──┬──┘  ┌──┴──┬──┴──┬──┴──┬──┴──┬──┴──┬──┴──┬──┴──┬──┴─────┤
   * │TAB     │  Q  │  W  │  E  │  R  │  T  │     │  Y  │  U  │  I  │  O  │  P  │  [  │  ]  │BSPC    │
   * ├────────┴┬────┴┬────┴┬────┴┬────┴┬────┴┐    └┬────┴┬────┴┬────┴┬────┴┬────┴┬────┴┬────┴────────┤
   * │CAPS     │  A  │  S  │  D  │  F  │  G  │     │  H  │  J  │  K  │  L  │  ;  │  '  │ENTER        │
  ...
  [_LOWER] = LAYOUT(
    ...
    RGB_TOG, _______, _______, KC_UP,   _______, _______,          _______, _______, _______, _______, _______, _______, _______, _______,
    ...
    MO_LOWR, KC_LCTL, KC_LALT, KC_LGUI, KC_SPC,                             KC_ENT, KC_RGUI, TG_LOWR, TG_RAIS, KC_RCTRL, KC_PGUP, KC_PGDOWN
  ),
  ...
  [_RAISE] = LAYOUT(
    ...
    _______, _______, KC_LEFT, KC_DOWN, KC_RGHT, _______,                   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, _______, _______,
    _______, _______, _______, _______, _______, _______,                   _______, _______, _______, _______, _______, _______, _______,
    MO_LOWR, KC_LCTL, KC_LALT, KC_LGUI, KC_SPC,                             MO_LOWR, KC_RGUI, TG_LOWR, TG_RAIS, KC_RCTRL, KC_PGUP, KC_PGDOWN
  ),
