...
#ifdef KEYBOARD_keebio_iris_nct_rev1
    #include "rev1.h"
// #elif KEYBOARD_keebio_iris_rev1_led
    // #include "rev1_led.h"
#elif KEYBOARD_keebio_iris_nct_rev2
    #include "rev2.h"
...
#define LAYOUT_kc( \
    ...
    LAYOUT( \
        ...
        KC_##L20, KC_##L21, KC_##L22, KC_##L23, KC_##L24, KC_##L25, KC_##LT4, KC_##RT4, KC_##R20, KC_##R21, KC_##R22, KC_##R23, KC_##R24, KC_##R25, \
